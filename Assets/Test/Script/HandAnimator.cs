...
public sealed class HandAnimator : MonoBehaviour
{
    ...
    [Space]
    [SerializeField] GameObject HANDUI = null;
       ...
       void AddCollider()
{
    ...
    meshCollider.sharedMesh = _boneMesh; // Use the same mesh for the collider
}
    ...
    void LateUpdate()
    {
        ...
        // }
        //var newform = CalculateJointXform(_pipeline.GetKeyPoint(0));
        Vector3 oldPosition = HANDUI.transform.position;
        HANDUI.transform.position = new Vector3(_pipeline.GetKeyPoint(0).x, _pipeline.GetKeyPoint(0).y, oldPosition.z);
